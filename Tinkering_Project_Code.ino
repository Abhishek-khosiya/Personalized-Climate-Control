...
void loop() {
  ...
  Serial.print(humidity);
  Serial.println("%");
 int temperature= temperatureC + 30 ;
...
void userProfile1(float temperature) {
  // USER1 Profile
  lcd.print("U1");
...
void manualProfile(float temperatureC) {
  ...
  if (fanSpeed < 20) { 
    ...
    lcd.print("   ");
    delay(1000);
  } else if (fanSpeed < 230) {
    lcd.print("Fan Speed: 40% ");
    lcd.print("   ");
    delay(1000);
  } else if (fanSpeed < 235) {
    lcd.print("Fan Speed: 60% ");
    lcd.print("   ");
    delay(1000);
  } else if (fanSpeed < 240) {
